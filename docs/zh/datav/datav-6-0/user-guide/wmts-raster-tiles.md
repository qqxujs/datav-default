...
**说明** 如果图层列表中没有WMTS栅格瓦片，说明您还未添加WMTS栅格瓦片图层，请参见[添加子组件](/zh/datav/datav-6-0/user-guide/layer-panel-management-of-professional-edition#section-1yb-xd4-pfe)进行添加。 
