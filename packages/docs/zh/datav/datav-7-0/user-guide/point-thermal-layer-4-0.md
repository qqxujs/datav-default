...
-   **通用**：设置点热力层的通用配置项。
    ...
    **不透明度**
    ...
    设置点热力层的不透明度值，取值范围为0~100，单位%，数值越大图层越不透明。
...
-   **图形**：设置点热力层的图形配置项。
    ...
    **热力颜色**
    ...
    设置热力点的颜色样式，请参见[颜色映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/instructions-of-color-mapper)，配置不同热力点的映射颜色样式。
    
    **热力半径**
    
    拖动滑块调整热力点的半径大小值，取值范围为0~100，单位px。
    
    **热力强度**
    
    设置热力点热力强度值，取值范围为0~3，单位px。
