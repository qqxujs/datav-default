...
-   **图表**
    ...
    -   **柱图样式**：柱图中每个柱子的样式。
        ...
        **描边颜色**
        ...
        胶囊柱子描边的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
        
        **外框颜色**
        
        胶囊外部边框的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
