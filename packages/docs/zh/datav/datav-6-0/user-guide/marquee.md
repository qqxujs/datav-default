  配置跑马灯组件的样式数据和交互-DataV数据可视化-阿里云
...
-   **文本样式**
    ...
    **字体颜色**
    ...
    组件文本的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。
