  DataV可视化实时计算时的数据源连接与数据同步常见问题-DataV数据可视化-阿里云
...
1.  流计算中注册**RDS数据存储**失败。
    ...
    解决方法：需要手动将流计算服务的白名单添加到RDS白名单中，详情请参见[数据存储白名单配置](https://help.aliyun.com/zh/flink/configure-a-whitelist-for-accessing-storage-resources-1#concept-92261-zh)。
