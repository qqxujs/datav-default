...
4.  在右侧的配置面板，修改组件的样式配置。
    ...
    在组件的样式配置面板，您可以调整组件的基础属性、全局样式、文本样式、内容样式等。![配置组件样式](//help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6256822951/p81106.png)
    
    **说明** 在配置页签，单击组件名称右侧的![详情配置项说明入口](//help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7256822951/p81107.png)图标，可打开该组件的配置项说明文档。
