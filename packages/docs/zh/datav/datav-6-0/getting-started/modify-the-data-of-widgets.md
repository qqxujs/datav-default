  为DataV模板组件配置静态数据源-DataV数据可视化-阿里云
...
2.  以模板画布中轮播列表组件为例，单击选中该组件后，在画布右侧配置面板的数据页签中，单击配置数据源。![配置数据源入口](//help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5256822951/p51528.png)
3.  在设置数据源页面中，选择数据源类型为静态数据。![选中静态数据](//help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5256822951/p81109.png)
4.  在下方的数据配置区域内，按照您的需求修改模板已有的数据，或粘贴准备好的JSON格式的数据。![修改数据](//help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6256822951/p81112.png)
    
    **说明** 添加数据时的字段名要和系统设置保持一致。
    
    数据配置完成后，您可以在设置数据源页面单击数据响应结果的![刷新](//help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6256822951/p95948.png)图标刷新数据响应结果。
    
    数据响应成功后，在数据页签会显示配置完成。
    
    ![匹配成功](//help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6256822951/p81113.png)
