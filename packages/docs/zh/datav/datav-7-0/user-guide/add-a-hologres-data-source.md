  为DataV添加Hologres数据源-DataV数据可视化-阿里云
    ...
    -   **专有网络**
        ...
        2.  填写数据库信息。
            ...
            **说明**
            ...
            Hologres实例的域名。进入[Hologres管理控制台](https://hologram.console.aliyun.com/#/instance)的实例详情页，从**网络信息**的指定VPC的**域名**列获取域名。
    ...
    -   **经典网络**
        ...
        2.  填写数据库信息。
            ...
            **说明**
            ...
            Hologres实例的域名。进入[Hologres管理控制台](https://hologram.console.aliyun.com/#/instance)的实例详情页，从**网络信息**的经典网络域名中获取域名。
...
5.  填写数据库信息。
    ...
    **说明**
    ...
    Hologres实例的域名。进入[Hologres管理控制台](https://hologram.console.aliyun.com/#/instance)的实例详情页，从**网络信息**的公网域名中获取域名。
