...
本文介绍v3.0以下版本的带图饼图的配置项，如需查看v3.0及以上版本，请参见[带图饼图（v3.0及以上版本）](/zh/datav/datav-6-0/user-guide/the-doughnut-chart-with-image-widget#concept-2354932)。
...
选中**启用**，开启组件交互功能。当单击带图饼图的扇形时，会触发数据请求，抛出回调值，动态加载不同扇形的数据。默认抛出数据中的x和y值，具体配置请参见[组件回调ID配置](/zh/datav/datav-6-0/user-guide/how-to-use-callback-ids-to-implement-component-linkage#concept-pbb-2vk-q2b)。 
