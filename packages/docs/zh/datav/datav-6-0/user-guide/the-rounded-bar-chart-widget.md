  组件样式数据交互全量配置项说明-DataV数据可视化-阿里云
...
-   **图表**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1428596761/p571093.png)
    ...
    -   **柱图样式**：柱图中每个柱子的样式。
        ...
        **外框颜色**
        ...
        胶囊外部边框的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。
    ...
    -   **值标签**：每个柱子值标签的样式，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8808332271/p274464.jpg)图标控制值标签的显隐。
        ...
        **位置**
        ...
        值标签文本的显示位置，可选**左侧**、**中间**、**右侧**和**右侧外部**四种样式。
    ...
    -   **x轴**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1428596761/p571094.png)
        ...
        -   **轴标签**：柱图的x轴的轴标签样式，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8808332271/p274464.jpg)图标控制轴标签的显隐。
            ...
            **显示格式**
            ...
            x轴轴标签数值显示格式的样式，可选**默认**、**11（整数）**、**11.1（浮点数）**、**11.11（浮点数）**、**11%**、**11.1%**和**11.11%**。
...
-   **其它**
    ...
    -   **提示框**：在预览或发布页面，鼠标悬浮或单击柱图时出现的提示框的样式，单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8808332271/p274464.jpg)图标可开启或关闭提示框。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1428596761/p571099.png)
        ...
        **背景框样式**
        ...
        -   **自定义**：提示框的宽度和高度，单位为px。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8808332271/p274464.jpg)图标可开启或关闭自义定提示框。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**水平胶囊柱状图**组件，在画布中可以看到如下图所示的水平胶囊柱状图的蓝图编辑器配置参数。![水平胶囊柱状图蓝图参数](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5356271161/p85267.jpg)
    ...
    -   **事件**
        ...
        **当水平胶囊柱状图接口请求完成时**
        ...
        数据接口请求返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板数据页签的数据响应结果区域。具体数据示例请参见画布编辑器中组件右侧配置面板**数据**页签的**数据响应结果**区域。
        ...
        **当点击数据项时**
        ...
        当单击水平胶囊柱状图的柱子时抛出的事件，同时抛出该柱子对应的数据项。
    ...
    -   **动作**
        ...
        **请求水平胶囊柱状图接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如水平胶囊柱状图配置了API数据源为`https://api.test`，传到**请求水平胶囊柱状图接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
