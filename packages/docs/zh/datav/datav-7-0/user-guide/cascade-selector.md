...
| **下拉框内容被选中时**  | 当下拉框内容被选中时抛出的事件，同时抛出该值对应的数据项，参考数据示例。\[   {     "value": "zhejiang",     "label": "浙江"   },   {     "value": "hangzhou",     "label": "杭州",     "title": "数据待接入"   } \] |
  * **动作**

| **动作**       | **说明**                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **导入数据接口**   | 按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据，参考数据示例。\[   {     "label": "浙江",     "value": "zhejiang"   } \]                                                                                                                                                                                                                                                                                                           |
...
| **设置选中的条目**  | 设置当前级联选择器选中的条目，参考数据示例。\[   "zhejiang",   "hangzhou",   "xihu" \]                                                                                                                                                                                                                                                                                                                                              |
| **清空选中的条目**  | 清空级联选择器选中条目的值，不需要参数。                                                                                                                                                                                                                                                                                                                                                                                          |
| **清空组件到默认值** | 将组件的默认值清空，不需要参数。                                                                                                                                                                                                                                                                                                                                                                                              |
