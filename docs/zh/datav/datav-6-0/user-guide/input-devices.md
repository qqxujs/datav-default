...
添加键盘节点至画布中，可查看键盘节点支持的事件和动作，以及配置参数。添加方式请参见[使用逻辑节点](/zh/datav/datav-6-0/user-guide/logic-nodes-overview#section-5b3-w0u-ud7)。 
...
__表 2\. 配置项说明 表格中仅提供其他配置中的参数说明，其他参数配置请参见[公共参数说明](/zh/datav/datav-6-0/user-guide/logic-nodes-overview#table-d04-vmz-ldb)。__
|    参数    |    说明    |
|    ----    |    ----    |
