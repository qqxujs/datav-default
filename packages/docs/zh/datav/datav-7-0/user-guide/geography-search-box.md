...
-   **搜索框样式**
    ...
    **颜色**
    ...
    搜索框中字体的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
    
    **背景色**
    
    搜索框的背景颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
...
-   **结果框样式** 结果框样式
    ...
    **悬停样式**
    ...
    鼠标移动到结果框时悬停的样式，包括结果框内字体的颜色、底部边框颜色和字体大小。
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9227002961/p705755.png)
    ...
    -   **事件**
        ...
        **当前值变化时**
        ...
        当前值发生变化时抛出的事件，同时抛出搜索地名和地区代码，参考数据示例。
