...
本文介绍标注对比饼图的图表样式和配置面板的功能。

**重要** 

本文介绍v3.0及以上版本的标注对比饼图的配置项，如需查看v3.0以下版本，请参见[标注对比饼图（v3.0以下版本）](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/comparison-pie-chart-ii#concept-h54-gsh-y2b)文档。

## **图表样式**

标注对比饼图是饼图的一种，与基本饼图相比，标注对比饼图支持真实值和百分比值的切换、多系列数据配置以及标签、图例、动画等配置，适用于比较平面化的数据占比情况展示。

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8012227761/p573116.png)

## 配置面板![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8012227761/p573134.png)
...
* ****图表**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8012227761/p573136.png)
...
* ****坐标轴**：饼图的径向轴和角度轴样式。
  ...
  * ****径向轴**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8012227761/p573137.png)
...
* ****系列**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8012227761/p573140.png)
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8012227761/p573141.png)
...
3. 在蓝图编辑器配置页面，单击导入节点栏内的****标注对比饼图**组件，在画布中可以看到如下图所示的标注对比饼图的蓝图编辑器配置参数。![标注对比饼图蓝图参数](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8231806361/p139569.png)

  * ****事件**

| **事件**               | **说明**                                                                                                               |
| ---- | ---- |
| ****当标注对比饼图接口请求完成时** | 数据接口请求返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板****数据**页签的****数据响应结果**区域。                           |
| ****当标注对比饼图接口请求失败时** | 数据接口请求失败时（请求失败的情况可能是：网络问题或接口报错等）返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板****数据**页签的****数据响应结果**区域。 |
  * ****动作**
...
| ****导入标注对比饼图接口** | 按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据。具体数据示例请参见画布编辑器中组件右侧配置面板****数据**页签的****数据响应结果**区域。                                                                                                                                                                                                                                                                                                                                 |
| ****清空组件**       | 清空组件，不需要参数。                                                                                                                                                                                                                                                                                                                                                                                                           |
