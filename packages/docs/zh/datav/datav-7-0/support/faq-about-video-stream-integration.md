...
推荐您使用阿里云流播放器，使用方法请参见[集成文档](https://help.aliyun.com/zh/vod/developer-reference/integration)。![阿里云流播放器](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5069036461/p410907.png)
...
当上述的视频组件不能满足播放需求时，您可以考虑自定义组件的方式来实现，自定义组件需要由前端开发人员介入去实现。实现方法请参见[组件开发快速入门](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/getting-started-for-developers)。
