...
**说明** 新创建的场景为空白场景，且新场景初始帧的相机视角将沿用当前场景视角。新场景在所选数据区域下不包含任何图层，您可以为新场景添加新的图层，或者从旧场景里分配图层到新场景内，详情请参见[图层配置项说明](/zh/datav/datav-6-0/user-guide/layer-configuration-items-of-previous-edition#concept-1988930)。
...
3. 成功导出当前场景到蓝图编辑器后，即可切换到蓝图编辑器页面，详细操作请参见[切换编辑器](/zh/datav/datav-6-0/user-guide/switch-editor-of-previous-edition#concept-2001301)。
