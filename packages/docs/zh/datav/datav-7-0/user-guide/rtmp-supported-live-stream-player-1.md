...
RTMP视频流播放器是媒体组件的一种，支持自定义视频的URL地址和类型，能够在数据看板中添加视频播放器来播放您的视频。RTMP视频流播放器组件只支持RTMP协议的视频流。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8279612961/p706660.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8279612961/p706661.png)
...
**重要**  
  * 只支持RTMP协议的视频流。
  * **样式**和**数据源**中均可配置视频流的地址和类型，DataV优先使用**数据源**中的配置。
* **视频流类型**：播放的视频流格式类型，可选**rtmp/mp4**和**rtmp/flv**。
* **静音**：打开开关，在预览或发布页面视频可静音播放；关闭开关，视频正常播放声音。

## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8279612961/p706662.png)
...
3. 查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8279612961/p706676.png)
