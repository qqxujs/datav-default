...
|    **增加**    |    类目数据为正数显示上升趋势的柱子的标题和颜色，颜色请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#concept-lsz-bc4-t2b/section-kdw-vj4-t2b)。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制增加配置项的显隐。    |
|    **减少**    |    类目数据为负数数显示下降趋势的柱子的标题和颜色，颜色请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#concept-lsz-bc4-t2b/section-kdw-vj4-t2b)。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制减少配置项的显隐。    |
|    **总计**    |    所有类目数据合计后的柱子的标题和颜色，颜色请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#concept-lsz-bc4-t2b/section-kdw-vj4-t2b)。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制总计配置项的显隐。    |
...
**当数据项选中时**：选中**启用**，开启组件交互功能。**瀑布图**组件拥有交互配置，当单击选中某个数据项时抛出回调值，默认抛出数据中的x和y字段。具体配置请参见[如何配置数字翻牌器组件的回调ID](/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards)。
