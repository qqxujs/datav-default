...
打开开关，开启组件交互功能。选中状态或取消选中时，触发数据请求，抛出临时变量，实现在选中状态或取消选中时，动态加载不同区域的数据。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。
