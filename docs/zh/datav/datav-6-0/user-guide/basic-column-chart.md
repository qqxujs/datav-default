...
本文介绍v3.0以下版本的基本柱图的配置项，如需查看v3.0及以上版本，请参见[基本柱状图（v3.0及以上版本）](/zh/datav/datav-6-0/user-guide/the-column-chart-widget#concept-2354382)。
...
* **全局样式**![全局样式面板3.0以下版本](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0328068951/p71043.png)
  ...
  * **柱子样式**：柱图中每个柱子的样式。  
    ...
    * **背景色**：柱子的背景颜色，请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。
...
选中**启用**，开启组件交互功能。当单击基本柱图的柱子时，会触发数据请求，抛出回调值，动态加载不同柱子的数据。默认抛出数据中的x、y和s值，具体配置请参见[组件回调ID配置](/zh/datav/datav-6-0/user-guide/how-to-use-callback-ids-to-implement-component-linkage#concept-pbb-2vk-q2b)。 
