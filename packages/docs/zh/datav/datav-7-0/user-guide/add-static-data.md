  添加静态数据作为数据源-DataV数据可视化-阿里云

本文档介绍在DataV中添加静态数据文件的方法。
...
5.  在**设置数据源**模块中，选择**数据源类型**为**静态数据**。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3533312761/p539784.png)
    
6.  将静态数据文件内容粘贴到上图的数据编辑框区域。
    
    **重要**
    
    文件大小需要小于512KB。
    
7.  单击**查看数据返回结果**，查看数据源的返回结果样式。
