...
在自定义组件中实现蓝图编辑器中事件触发功能，以数字翻牌器组件的**当前值变化**事件为例。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0283530961/p698013.png)
...
4.  打开`index.js`文件，设置代码中的`emit`的事件名。
...
在自定义组件中实现蓝图编辑器中**导入数据接口**动作，以数字翻牌器组件的**导入数据接口**动作为例。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1283530961/p698017.png)
...
在自定义组件中实现蓝图编辑器中多个交互动作，以数字翻牌器组件的**显示**和**隐藏**动作为例。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1283530961/p698020.png)
