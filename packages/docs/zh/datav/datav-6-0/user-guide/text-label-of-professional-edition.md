...
-   文字标签配置面板中的参数说明。
    ...
    -   图形
        ...
        -   指示线样式：设置指示线的样式。
            ...
            -   颜色：指示线的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)修改颜色。
        -   顶端图标：指示线顶端图标的样式。
        ...
        -   粗细：设置主内容字体的粗细样式。
        -   字号：设置主内容的字号大小。
        -   颜色：主内容字体的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)修改颜色。
        ...
        -   图片：设置背景框的图片样式，仅在样式类型选择图片时显示。
            ...
            -   鼠标移动到图片位置，单击更改可重新上传本地图片。
            -   您也可以输入图片的URL地址，将远程服务器上的图片作为文字标签图标。
        -   背景颜色：背景框的背景颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)修改颜色。仅在样式类型选择自定义时显示。
