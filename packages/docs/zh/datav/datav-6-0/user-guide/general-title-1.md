...
|    **字号**    |    标题文本的字体大小。    |
|    **字体颜色**    |    标题文本的颜色，请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。    |
|    **字体粗细**    |    标题文本的字体粗细。    |
...
|    **参数**    |    **说明**    |
|    ----    |    ----    |
|    **背景色**    |    标题背景框内的颜色，请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。    |
