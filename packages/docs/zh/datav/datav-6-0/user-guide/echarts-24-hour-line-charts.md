  Echarts 24时折线图的配置项数据格式与交互设置-DataV数据可视化-阿里云

本文介绍Echarts 24时折线图的图表样式和配置面板的功能。

## **图表样式**

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1983507761/p571604.png)

## 配置面板![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1983507761/p571605.png)
...
-   **x轴**：单击右侧的**眼睛**图标显示x轴样式。![x轴](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1488810661/p476746.jpg)
    ...
    -   **轴线**：单击右侧的**眼睛**图标显示x轴轴线。
        ...
        -   **在零上**：x轴或者 y轴的轴线是否在另一个轴的0刻度上，只有在另一个轴为数值轴且包含0刻度时有效。
    ...
    -   **刻度标签**：单击右侧的**眼睛**图标显示x轴刻度标签。
        ...
        -   **显示格式**：设置刻度标签的显示格式，例如**06**，**06:00**和**06时**。
...
-   **系列**：单击右侧的![加号图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p89097.jpg)或![垃圾桶图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3208049161/p89098.jpg)图标，添加或删除一个条件样式。 单击![横排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p95437.jpg)或![竖排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p94077.jpg)图标配置多个条件样式的排列样式。单击![复制图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5896941261/p271562.jpg)图标，即可复制当前选中的条件样式配置并新增一个同样配置的条件样式。![系列](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1488810661/p476748.jpg)
    
    -   **类型**：设置系列的类型。包括但不限于**line**和**bar**。
        
    -   **名称**：自定义系列名称，需要与数据中的s字段值配合使用。
        
    -   **标记图形**：自定义标记图形，默认值为**圆形**。标记类型包括 **无**，**圆形**，**方形**，**圆角方形**，**三角形**，**菱形**， **针型**和**箭头型** ，详细请参考[ECharts官网](https://echarts.apache.org/zh/option.html#series-line.markPoint.symbol)。
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1983507761/p571607.png)
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1983507761/p571608.png)
...
选中**启用**，开启组件交互功能。**24时折线图**组件拥有交互配置，当单击选中某个数据项时抛出回调值，默认抛出数据中的x和y字段。具体配置请参见[如何配置数字翻牌器组件的回调ID](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards)。

**当图例点击时**

选中**启用**，开启组件交互功能。**24时折线图**组件拥有交互配置，当单击某个图例时抛出回调值，默认抛出数据中的selected字段。具体配置请参见[如何配置数字翻牌器组件的回调ID](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards)。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**24时折线图**组件，在画布中可以看到如下图所示的24时折线图的蓝图编辑器配置参数。![蓝图](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1488810661/p476794.jpg)
    ...
    -   事件
        ...
        **当点击数据项时**
        ...
        当单击24时折线图的柱子时抛出的事件，同时抛出该柱子对应的数据项。
        
        **当图例点击时**
        
        当单击24时折线图的图例时抛出的事件，同时抛出该柱子对应的数据项。
