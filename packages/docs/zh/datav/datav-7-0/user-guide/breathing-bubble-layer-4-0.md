...
-   **图形**：设置呼吸气泡层的图形配置项，包括气泡的形状样式、半径大小样式和气泡颜色样式。
    ...
    **相对偏移**
    ...
    设置呼吸气泡相对于当前气泡中心点水平方向和垂直方向的偏移值，范围为-100~100，单位px。
    
    **旋转**
    
    设置呼吸气泡相对于当前气泡中心点的旋转角度。
    ...
    **气泡样式**
    ...
    -   **形状**：呼吸气泡层内的图标样式，您可以单击样式右侧的下拉选项框，选择系统内置多种图标样式；也可在下拉框面板的输入框内自定义输入图片的URL地址，将远程服务器上的图片作为气泡图标；或者单击输入框右侧的![上传按键](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3366732361/p310531.jpg)图标，上传本地图片作为气泡图标。
    ...
    -   **动画**：设置气泡呼吸动画。
        ...
        -   **速度**：设置气泡的动画执行时间，范围为500~5000，单位ms。
...
-   **标签**：设置呼吸气泡层内标签的样式参数。
    ...
    **显示方式**
    ...
    设置呼吸气泡层的标签显示的方式，包括**点击**和**悬浮**。
    
    **相对位置**
    
    设置呼吸气泡层的标签的相对位置样式，包括**左侧**、**中心**、**右侧**、**顶部**和**底部**。
...
-   **交互**：呼吸气泡层的交互配置项。
    ...
    **点击态**
    ...
    -   **图形**：设置**点击态**时呼吸气泡层图形样式，包括**气泡半径**、**相对偏移**、**旋转**、**气泡样式**。
        
    -   **标签**：设置**点击态**时呼吸气泡层标签，包括**显示标签**、**相对位置**、**相对偏移**、**内容样式**、**背景样式**。
    ...
    **悬浮态**
    ...
    -   **图形**：设置**悬浮态**时呼吸气泡层图形样式，包括****气泡半径**、**相对偏移**、**旋转**、**气泡样式****。
        
    -   **标签**：设置**悬浮态**时呼吸气泡层标签，包括**显示标签**、**相对位置**、**相对偏移**、**内容样式**、**背景样式**。
...
-   **条件**：条件样式说明。
    ...
    **气泡半径**
    ...
    设置呼吸气泡的半径大小值，可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
    
    **旋转**
    
    设置呼吸气泡相对于当前气泡中心点的旋转角度，可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
    
    **气泡样式**
    
    单击**气泡样式**右侧的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528933.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528934.png)图标，添加或删除一个气泡样式。单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528936.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528937.png)图标配置多个气泡样式的页面布局。单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528938.png)图标，即可复制当前选中样式配置内容并新增一个同样配置的气泡样式。
    
    -   **形状**：呼吸气泡层内的图标样式，您可以单击样式右侧的下拉选项框，选择系统内置多种图标样式；也可在下拉框面板的输入框内自定义输入图片的URL地址，将远程服务器上的图片作为气泡图标；或者单击输入框右侧的![上传按键](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3366732361/p310531.jpg)图标，上传本地图片作为气泡图标，并通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
        
    -   **颜色**：设置气泡的颜色样式，可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
        
    -   **尺寸比例**：设置气泡相对于根据**气泡半径**配置项生成的图标的缩放比例，范围为0~1，可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
        
    -   **动画**：设置气泡呼吸动画，可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前动画样式。
