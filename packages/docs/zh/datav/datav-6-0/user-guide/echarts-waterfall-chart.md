...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2515307761/p571633.png)

## 配置面板![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2515307761/p571634.png) 
...
* **y轴**：请参考**x轴**样式进行配置。
* **数据缩放**：单击右侧的**眼睛**图标显示数据缩放。![数据缩放](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8668070661/p478176.jpg)
...
* **提示框**：单击右侧的**眼睛**图标显示提示框。![提示框](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6833200661/p476196.jpg)
  ...
  * **坐标轴指示器**：单击右侧的**眼睛**图标显示坐标轴指示器。
    ...
    * **文本样式**
      ...
      * **字体**：提示框标签文本的字体系列。
      * **字号**：提示框标签文本的字体大小。
* **系列**：单击右侧的![加号图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p89097.jpg)或![垃圾桶图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3208049161/p89098.jpg)图标，添加或删除一个条件样式。 单击![横排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p95437.jpg)或![竖排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p94077.jpg)图标配置多个条件样式的排列样式。单击![复制图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5896941261/p271562.jpg)图标，即可复制当前选中的条件样式配置并新增一个同样配置的条件样式。![系列](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8668070661/p478236.jpg)
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2515307761/p571635.png)
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2515307761/p571637.png)

### **交互说明**

| **交互**       | **说明**                                                                                                                                                                                                     |
| ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **当点击数据项时**  | 选中**启用**，开启组件交互功能。**瀑布图**组件拥有交互配置，当单击选中某个数据项时抛出回调值，默认抛出数据中的x和y字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。    |
| **当图例点击时**   | 选中**启用**，开启组件交互功能。**瀑布图**组件拥有交互配置，当单击某个图例时抛出回调值，默认抛出数据中的selected字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。  |
| **当数据缩放改变时** | 选中**启用**，开启组件交互功能。**瀑布图**组件拥有交互配置，当数据缩放改变时抛出回调值，默认抛出数据中的start和end字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。 |

## 蓝图编辑器交互配置

1. 在画布编辑器页面，右键单击组件，选择**导出到蓝图编辑器**。
2. 单击页面左上角的![蓝图图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7416559951/p101929.png)图标。
3. 在蓝图编辑器配置页面，单击导入节点栏内的**瀑布图**组件，在画布中可以看到如下图所示的瀑布图的蓝图编辑器配置参数。![蓝图](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8668070661/p478244.jpg)
...
| **当图例点击时**     | 当单击瀑布图的图例时抛出的事件，同时抛出该柱子对应的数据项。                                                                                   |
| **当数据缩放改变时**   | 当数据缩放改变时抛出的事件，同时抛出该柱子对应的数据项。                                                                                     |
  * 动作
