...
点热力层是基础平面地图 3.0的子组件，支持独立的样式、数据和交互配置，包括热力颜色、热力半径和热力模糊度等。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9669831961/p702950.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0769831961/p702953.png)
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9669831961/p702954.png)
...
3. 查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6732221071/p742534.png)

  * **事件**

| **事件**            | **说明**                                                                                  |
| ----------------- | --------------------------------------------------------------------------------------- |
| **当热力点数据接口请求完成时** | 数据接口请求返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。 |
  * **动作**
...
| **导入热力点数据接口** | 按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。                                                  |
