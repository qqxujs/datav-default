...
-   **通用**：设置轨迹线层的通用配置参数项。
    ...
    **可见级别**
    ...
    设置轨迹线层的可见级别值，在设定的级别范围内轨迹线层可见，级别之外不可见。取值范围为0~22，单位级。
...
-   **图形**：设置轨迹线层的图形样式参数项。
    ...
    **轨迹粗细**
    ...
    设置轨迹线的粗细大小值，请参见[尺寸映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/dimension-mapper-instructions)，配置不同轨迹线的粗细大小映射样式。
    
    **轨迹颜色**
    
    数据中`colorField`字段值对应轨迹线的颜色。请参见[颜色映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/instructions-of-color-mapper)，配置不同轨迹线的映射颜色样式。
...
-   **交互**：轨迹线层的交互配置项。
    ...
    **点击态**
    ...
    设置点击聚焦和图形，可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在**图形交互**点击态是否启用。
    
    -   **点击聚焦**：单击左侧![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，可控制点击聚焦交互功能的开启或关闭。开启后，单击轨迹线，会根据轨迹线位置进行一定范围比例的聚焦，聚焦范围内边距的取值范围为0~300。
        
        **说明**
        
        地图只有在交互模式、预览或发布时才能呈现效果。
        
    -   **图形**：设置**点击态**时轨迹线图形样式，包括**轨迹线型**、**轨迹粗细**、**轨迹颜色**。
    ...
    **悬浮态**
    ...
    -   **图形**：设置**悬浮态**时动态轨迹线图形样式，包括****轨迹线型**、**轨迹粗细**、**轨迹颜色****。
...
-   **条件**：条件样式说明。
    ...
    **轨迹线型**
    ...
    单击下拉框，选择一种轨迹线类型样式，系统默认内置四种类型轨迹线。可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
    
    **轨迹粗细**
    
    设置轨迹线的粗细大小值，范围为0~20，单位px。可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
    
    **轨迹颜色**
    
    配置轨迹线的颜色，可通过![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，确认在符合当前条件时是否应用当前样式。
...
3.  查看蓝图配置参数。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6579088371/p878354.png)
    ...
    -   **动作**
        ...
        **请求数据**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如轨迹线层配置了API数据源为`https://api.test`，传到**请求数据**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
