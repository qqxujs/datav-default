...
-   **日历**
    ...
    -   **分割线**：单击右侧的**眼睛**图标显示日历坐标分割线。
        ...
        -   **轴线样式**
            ...
            -   **颜色**：参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改分割线轴线的颜色。
    ...
    -   **星期标签**
        ...
        -   **文本样式**
            ...
            -   **颜色**：参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改星期标签文本的颜色。
    ...
    -   **月标签**
        ...
        -   **文本样式**
            ...
            -   **颜色**：参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改月份标签文本的颜色。
    ...
    -   **年标签**
        ...
        -   **文本样式**
            ...
            -   **颜色**：参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改年份标签文本的颜色。
...
打开开关，开启组件交互功能。当单击选中某个数据项时抛出回调值，默认抛出数据中的`name`、`value`和`s`字段。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1921962961/p709331.png)
    ...
    -   **事件**
        ...
        **当点击数据项时**
        ...
        当单击日历图的数据时抛出的事件，同时抛出对应的数据项。
        
        **当图例点击时**
        
        当单击日历图的图例时抛出的事件，同时抛出对应的数据项。
