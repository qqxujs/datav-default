...
平行光层是3D地球的子组件，支持独立的样式配置，包括平行光的颜色、强度、位置等，适用于模拟一个平行光照射在地球球体上的效果。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4966841961/p703627.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4966841961/p703628.png)
...
* **颜色**：平行光的光照颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
...
3. 查看蓝图配置参数。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6484082761/p542382.png)
