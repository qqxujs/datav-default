...
4.  区块信息填写完成后，单击**确定**，完成创建一个空白区块。创建完成后系统会自动跳转到[区块编辑器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/block-editor-overview-7-0/)面板中。
...
3.  在弹出的**创建区块**对话框中，填写被创建的区块信息。![{1192CA21-C3A7-491F-ABB3-723BB74E8FFE}](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6364043471/p926164.png)
    ...
    **英文名**
    ...
    （必填）输入模板区块的英文名，20字符以内的英文，数字及中划线，不可以有空格，创建后不可修改。如`block-test-xz`，英文名称必须是唯一的，不能与系统中其它区块重名。
...
4.  您可以选中画布中已添加的区块，在右侧面板中查看该区块组件对应的**样式**、**数据源**和**高级**页签内容。区块配置与[组件配置方法](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items)一致。
    

## **编辑区块**

区块支持通过[区块编辑器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/block-editor-overview-7-0/)进行配置和使用。
...
3.  在预览页内，您可以查看区块的整体样式，并配置右侧的**样式**、**数据**、**事件**和**动作**等功能。操作示例如下表：
    ...
    在样式页签内配置不同的样式，请参考[配置项说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items)。
    ...
    在动作页签中，针对某个动作输入不同的参数，查看该动作对应内部组件的行为是否符合预期。
...
2.  在右侧弹出的历史版本面板中，您可以查看当前区块的所有版本，包括区块的**版本号**、**发布时间**、**说明**、**状态**和**操作**等信息。![{9CB1834E-63CF-4FC6-88EA-D6B41214977D}](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6364043471/p926215.png)
    ...
    **操作**
    ...
    -   **上线**：单击一个**未上线**状态下区块右侧的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4952082761/p523940.png)即可。
        
    -   **下线**：单击一个**已上线**状态下区块右侧的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4952082761/p523941.png)即可。
