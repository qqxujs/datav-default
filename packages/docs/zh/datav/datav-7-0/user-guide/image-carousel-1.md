...
-   **描述**：轮播图中每张图片的描述样式，可单击![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标控制描述的显隐。
    ...
    -   **背景颜色**：描述模块的背景颜色。
        ...
        **开始颜色**
        ...
        背景的开始颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改，仅当**颜色样式**为**渐变**时有效。
...
轮播图片的URL，与样式面板中**图片>默认图片**配置项功能相同。如果同时配置，则以url中的内容为准。
