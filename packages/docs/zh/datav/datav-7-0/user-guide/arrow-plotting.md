...
-   **线样式**：箭头标绘中线条的样式。
    ...
    **填充颜色**
    ...
    线条的填充颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
...
-   **箭头样式**：箭头标绘中箭头的样式。
    ...
    **填充颜色**
    ...
    箭头的填充颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
...
-   **文本样式**：箭头标绘中文本的样式。
    ...
    **字体颜色**
    ...
    文本的字体颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
...
箭头标绘组件中的文字动画，_true_表示开启动画；_false_表示关闭动画。

`lineAnimate`

箭头标绘组件中的虚线动画，_true_表示开启动画；_false_表示关闭动画。
