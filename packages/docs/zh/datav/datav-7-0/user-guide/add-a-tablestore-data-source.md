  添加TableStore数据源并在组件中使用-DataV数据可视化-阿里云
...
4.  填写TableStore相关信息。
    ...
    **AK ID**
    ...
    拥有TableStore访问权限的账号的AccessKey ID。
    
    **AK Secret**
    
    拥有TableStore访问权限的账号的AccessKey Secret。
    
    **外网**
    
    TableStore的[服务地址](https://help.aliyun.com/zh/tablestore/endpoints#concept-bsx-btj-bfb)，需要根据访问的TableStore实例来填写。
