...
## **图表样式**![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7119962961/p709385.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7119962961/p709384.png)
...
-   **图例**：单击右侧的**眼睛**图标显示图例样式。
    ...
    -   **对齐**：图例的对齐方式，可选，默认为**居中对齐**。也可以为**左对齐**或**右对齐**。
...
-   **x轴**：单击右侧的**眼睛**图标显示x轴样式。
    ...
    -   **类型**：坐标轴类型，可选：
        ...
        -   **category**：类目轴，适用于离散的类目数据，为该类型时必须在数据面板设置类目数据。
    ...
    -   **轴线**：单击右侧的**眼睛**图标显示x轴轴线。
        ...
        -   **在零上**：x轴或者y轴的轴线是否在另一个轴的 0 刻度上，只有在另一个轴为数值轴且包含 0 刻度时有效。
...
-   **系列**：单击右侧的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528933.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528934.png)图标，添加或删除一个条件样式。 单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528936.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528937.png)图标配置多个条件样式的排列样式。单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528938.png)图标，即可复制当前选中的条件样式配置并新增一个同样配置的条件样式。
    ...
    -   **极坐标索引**：使用的极坐标系的索引，默认为 **0**，在单个图表实例中存在多个极坐标系的时候有用。
        
    -   **geo索引**：使用的地理坐标系的索引，默认为 **0**，在单个图表实例中存在多个地理坐标系的时候有用。
        
    -   **calendarIndex**：使用的日历坐标系的索引，默认为 **0**，在单个图表实例中存在多个日历坐标系的时候有用。
    ...
    -   **标记尺寸**：单击**+**或**\-**号，或手动输入数值，修改标记图形的大小。
        
    -   **标记旋转角度**：单击**+**或**\-**号，或手动输入数值，修改标记图形的旋转角度。
        
    -   **大规模优化**：是否开启大数据量优化，在数据图形特别多而出现卡顿时候可以开启。开启后配合**绘制优化阈值**配置项，在数据量大于指定阈值的时候对绘制进行优化。但是优化后不能自定义设置单个数据项的样式。
        
    -   **绘制优化阈值**：绘制优化的阈值，默认为**2000**。
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7119962961/p709401.png)
...
## 高级面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7119962961/p709403.png)
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7119962961/p709411.png)
    ...
    -   **事件**
        ...
        **当点击数据项时**
        ...
        当单击大规模散点图的数据时抛出的事件，同时抛出对应的数据项。
        
        **当图例点击时**
        
        当单击大规模散点图的图例时抛出的事件，同时抛出对应的数据项。
    ...
    -   **动作**
        ...
        **请求数据接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如大规模散点图配置了API数据源为`https://api.test`，传到**请求数据接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
