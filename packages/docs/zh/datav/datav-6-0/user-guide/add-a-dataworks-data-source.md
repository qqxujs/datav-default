...
* 如果您需要在HTTPS协议下使用DataWorks数据服务生成的API，请绑定证书到API网关，详细绑定过程请参见[如何使您的API支持HTTPS](/zh/api-gateway/traditional-api-gateway/how-to-make-your-api-support-https)。
