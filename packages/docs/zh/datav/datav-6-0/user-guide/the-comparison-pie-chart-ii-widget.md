# 标注对比饼图（v3.0及以上版本） %{#348795}% 

本文介绍标注对比饼图的图表样式和配置面板的功能。

**重要** 

本文介绍v3.0及以上版本的标注对比饼图的配置项，如需查看v3.0以下版本，请参见[标注对比饼图（v3.0以下版本）](/zh/datav/datav-6-0/user-guide/comparison-pie-chart-ii#concept-h54-gsh-y2b)文档。
