...
| **字号**    | 搜索框中字体的大小。                                                                                                                        |
| **字体粗细**  | 搜索框中字体的粗细。                                                                                                                        |
| **颜色**    | 搜索框中字体的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。 |
| **背景色**   | 搜索框的背景颜色。                                                                                                                         |
...
| **底部边框颜色** | 结果框的底部边框颜色。                              |
| **背景色**    | 结果框的背景颜色。                                |
| **悬停样式**   | 鼠标移动到结果框时悬停的样式，包括结果框内的字体颜色 、底部边框颜色和字体大小。 |
