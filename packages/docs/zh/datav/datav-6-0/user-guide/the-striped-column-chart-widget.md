    ...
    -   **x轴**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9497786761/p569808.png)
        ...
        -   **轴标签**：柱图的x轴的轴标签样式，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制x轴轴标签的显隐。
            ...
            **轴标签展示**
            ...
            x轴轴标签的角度样式，可选**水平**、**斜角**和**垂直**三种。x轴轴标签的数量和单位。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**斑马柱状图**组件，在画布中可以看到如下图所示的斑马柱状图的蓝图编辑器配置参数。![斑马柱状图蓝图参数](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5556271161/p85340.jpg)
    ...
    -   **动作**
        ...
        **请求斑马柱状图接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如斑马柱状图配置了API数据源为`https://api.test`，传到**请求斑马柱状图接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
