...
Echarts 标注气泡柱状图是柱状图的一种，该图表将柱形图和气泡图进行组合，可以在可视化应用内对进行直接比较和占比大小比较。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8019962961/p709238.png)

## **样式面板**![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8019962961/p709243.png)
...
-   **系列**：单击右侧的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528933.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528934.png)图标，添加或删除一个条件样式。 单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528936.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528937.png)图标配置多个条件样式的排列样式。单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528938.png)图标，即可复制当前选中的条件样式配置并新增一个同样配置的条件样式。
    ...
    -   **坐标系**：该系列使用的坐标系，可选，默认为**cartesian2d**。
    ...
    -   **图表平均线**
        ...
        -   **颜色**：参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改图表平均线的颜色。
            
        -   **样式**：自定义图表平均线的描边类型，包括**实线**和**虚线**。默认值为**虚线**。
            
    -   **图表标记**
        
        -   **颜色**：参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改图表平均线的颜色。
            
        -   **标记图形**：自定义标记图形，默认值为**pin**。标记类型包括 **circle**，**rect**，**roundRect**，**triangle**，**diamond**， **arrow**和**pin** ，详细请参考[ECharts官网](https://echarts.apache.org/zh/option.html#series-line.markPoint.symbol)。
            
        -   **标记尺寸**：单击**+**或**\-**号，或手动输入数值，修改标记尺寸大小，单位为px。
            
        -   **标记旋转角度**：单击**+**或**\-**号，或手动输入数值，修改标记旋转角度，单位为度。
            
        -   **字号**：单击**+**或**\-**号，或手动输入数值，修改图表标记的字体大小。
            
        -   **字体颜色**：参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改图表标记的字体颜色。
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8019962961/p709253.png)
...
## 高级面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8019962961/p709256.png)
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8019962961/p709258.png)
    ...
    -   **事件**
        ...
        **当点击数据项时**
        ...
        当单击标注气泡柱状图的数据时抛出的事件，同时抛出对应的数据项。
        
        **当图例点击时**
        
        当单击标注气泡柱状图的图例时抛出的事件，同时抛出对应的数据项。
    ...
    -   **动作**
        ...
        **请求数据接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如标注气泡柱状图配置了API数据源为`https://api.test`，传到**请求数据接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
