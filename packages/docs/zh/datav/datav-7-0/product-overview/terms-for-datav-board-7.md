  DataV-Board基本概念\_DataV数据可视化(DataV)-阿里云帮助中心
...
下表提供了部分数据格式的示例，更多数据显示格式使用请参见[https://github.com/d3/d3-format/blob/v3.1.0/README.md#format](https://github.com/d3/d3-format/blob/v3.1.0/README.md#format)。
...
十六进制表示法，使用小写字母，四舍五入为整数

48879 => beef

X

十六进制表示法，使用大写字母，四舍五入为整数
