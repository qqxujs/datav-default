  蜂窝聚合层（v3.x版本）的样式数据与交互配置-DataV数据可视化-阿里云
...
-   **图形**：设置蜂窝聚合层的图形配置项。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4908348761/p581493.png)
    ...
    **蜂窝间距**
    ...
    拖动滑块，调整蜂窝之间的距离，取值范围为0~100。
    
    **蜂窝高度**
    
    拖动滑块，调整蜂窝的高度值，取值范围为0.1~100。
    ...
    **顶面样式**
    ...
    -   **金属质感**：拖动滑块设置蜂窝聚合层顶面的金属质感，取值范围为0~100。
        
    -   **纹理贴图**：设置顶面纹理贴图的样式。
        
    -   **发光贴图**：设置顶面发光贴图的样式。拖动强度滑块，设置贴图的发光强度，取值范围为0~100。单击**发光贴图**左侧的![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，可控制**发光贴图**样式的显隐。
        
    
    **侧面样式**
    
    -   **金属质感**：拖动滑块设置蜂窝聚合层侧面的金属质感，取值范围为0~100。
        
    -   **纹理贴图**：设置侧面纹理贴图的样式。
        
    -   **发光贴图**：设置侧面发光贴图的样式。单击**发光贴图**左侧的![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标，可控制**发光贴图**样式的显隐。
