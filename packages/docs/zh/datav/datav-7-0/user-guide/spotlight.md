...
-   **图形**
    ...
    **光照颜色**
    ...
    聚光灯光照的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)修改颜色。
    ...
    **说明**
    ...
    开启聚光灯投射阴影效果，需要其他组件材质支持接受阴影，而且光影会影响所有支持该光源的材质，使用投射阴影会使得电脑配置性能开销变大，请谨慎使用该功能。
