  配置Echarts 标注气泡柱状图的样式数据与交互-DataV数据可视化-阿里云

本文介绍Echarts 标注气泡柱状图的图表样式和配置面板的功能。

## **图表样式**

Echarts 标注气泡柱状图是柱状图的一种，该图表将柱形图和气泡图进行组合，可以在可视化应用内对进行直接比较和占比大小比较。

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6787496761/p570559.png)

## 配置面板![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6787496761/p570561.png)
...
-   **x轴**：单击右侧的**眼睛**图标显示x轴样式。 ![x轴](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4864221661/p479842.jpg)
...
-   **系列**：单击右侧的![加号图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p89097.jpg)或![垃圾桶图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3208049161/p89098.jpg)图标，添加或删除一个条件样式。 单击![横排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p95437.jpg)或![竖排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p94077.jpg)图标配置多个条件样式的排列样式。单击![复制图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5896941261/p271562.jpg)图标，即可复制当前选中的条件样式配置并新增一个同样配置的条件样式。![系列](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4864221661/p479849.jpg)
    ...
    -   **图表平均线**
        ...
        -   **颜色**：参考[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改图表平均线的颜色。
    ...
    -   **图表标记**
        ...
        -   **标记图形**：自定义标记图形，默认值为**pin**。标记类型包括 **circle**，**rect**，**roundRect**，**triangle**，**diamond**， **arrow**和**pin** ，详情请参考[ECharts官网](https://echarts.apache.org/zh/option.html#series-line.markPoint.symbol)。
        ...
        -   **字体颜色**：参考[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改图表标记的字体颜色。
...
![数据](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4864221661/p479874.jpg)
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6787496761/p570562.png)
...
选中**启用**，开启组件交互功能。**标注气泡柱状图**组件拥有交互配置，当单击选中某个数据项时抛出回调值，默认抛出数据中的x和y字段。具体配置请参见[如何配置数字翻牌器组件的回调ID](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards)。

**当图例点击时**

选中**启用**，开启组件交互功能。**标注气泡柱状图**组件拥有交互配置，当单击某个图例时抛出回调值，默认抛出数据中的selected字段。具体配置请参见[如何配置数字翻牌器组件的回调ID](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards)。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**标注气泡柱状图**组件，在画布中可以看到如下图所示的标注气泡柱状图的蓝图编辑器配置参数。![蓝图](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4864221661/p479879.jpg)
    ...
    -   事件
        ...
        **当点击数据项时**
        ...
        当单击标注气泡柱状图的柱子时抛出的事件，同时抛出该柱子对应的数据项。
        
        **当图例点击时**
        
        当单击标注气泡柱状图的图例时抛出的事件，同时抛出该柱子对应的数据项。
