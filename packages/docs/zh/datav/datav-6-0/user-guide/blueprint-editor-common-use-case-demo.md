  如何通过理论介绍及实操演示解决问题\_DataV数据可视化(DataV)-阿里云帮助中心
...
5.  如果您想查看**请求数据接口时动态传递参数**的详细方法，请参见：[如何在请求数据接口时传递动态参数](https://help.aliyun.com/document_detail/151285.html)。
...
2.  如果您想查看**动态控制组件样式**的详细方法，请参见：[如何动态控制组件样式](https://help.aliyun.com/document_detail/151280.html)。
...
3.  在蓝图画布编辑器中单击添加一个**全局节点**和**序列执行节点**，按照下图连线。设置页面临时变量的方法请参见：[全局节点](https://help.aliyun.com/document_detail/142628.html)。![数据累加展示蓝图配置](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1268631461/p379639.png)
...
6.  如果您想查看**多个组件数据累加展示**的详细方法，请参见：[如何展示多个实时数据相加结果](https://help.aliyun.com/document_detail/151284.html)。