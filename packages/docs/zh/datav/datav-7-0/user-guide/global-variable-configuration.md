...
不同来源类型使用方式，请参见[全局变量](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/use-global-variables)。
...
可选，通过添加数据过滤器进一步筛选所需数据。详情请参见[过滤器配置与使用](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/use-filters-in-canvas-on-pcs)。
