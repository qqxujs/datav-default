...
-   **图形**
    ...
    **柱子背景色**
    ...
    柱子的背景色，包括柱子的背景颜色和不透明度。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制柱子背景色的显隐。
    
    **柱子发光**
    
    柱子的发光样式，单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制柱子发光配置项的显隐。
    ...
    **柱子标签**
    ...
    柱子的标签样式，单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制柱子标签配置项的显隐。
    ...
    -   **X轴**
        ...
        -   **轴标签**：柱图的X轴轴标签样式，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制X轴轴标签的显隐。
            ...
            **标签展示**
            ...
            标签的展示样式，包括：轴标签的期望的刻度数量、标签的前后缀内容、标签的角度值、偏移量和标签展示时候的对齐方式。
...
-   **图例**：区间柱状图的图例样式。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标可开启或关闭图例效果。
    ...
    **分类图例**
    ...
    分类型图例的样式。只有当组件样式面板中的**图形柱子颜色映射类型**配置为**名词分类**时，图例才展示成分类型图例。
    ...
    **连续图例**
    ...
    -   **标签样式**：图例上文字标签的样式。
        ...
        -   **对齐方式**：图例中文字标签相对于滑轨的对齐方式，包括**顶端****对齐**、**居中对齐**和**底端对齐**。
...
打开开关，开启组件交互功能。当单击选中某个数据项时抛出临时变量，默认抛出数据中的`x`、`y1`、`y2`和`colorField`字段。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2583360071/p740428.png)
    ...
    -   **事件**
        ...
        **当数据项选中时**
        ...
        当单击区间柱状图的柱子时抛出的事件，同时抛出该柱子对应的数据项。
        
        **当图例被点击时**
        
        当单击区间柱状图的图例时抛出的事件，同时抛出该柱子对应的数据项。
    ...
    -   **动作**
        ...
        **请求区间柱状图接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如区间柱状图配置了API数据源为`https://api.test`，传到**请求区间柱状图接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
