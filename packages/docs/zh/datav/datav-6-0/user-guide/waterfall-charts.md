...
| **增加**   | 类目数据为正数显示上升趋势的柱子的标题和颜色，颜色请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#concept-lsz-bc4-t2b/section-kdw-vj4-t2b)。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制增加配置项的显隐。                                                                                                                                                                                                                                                                                                                                   |
| **减少**   | 类目数据为负数数显示下降趋势的柱子的标题和颜色，颜色请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#concept-lsz-bc4-t2b/section-kdw-vj4-t2b)。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制减少配置项的显隐。                                                                                                                                                                                                                                                                                                                                  |
| **总计**   | 所有类目数据合计后的柱子的标题和颜色，颜色请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#concept-lsz-bc4-t2b/section-kdw-vj4-t2b)。单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制总计配置项的显隐。                                                                                                                                                                                                                                                                                                                                       |
| **牵引线**  | 柱图之间的牵引线样式，包括线的形状、线的粗细和线的颜色，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制X轴轴线样式的显隐。**说明** 当线的类型选择**虚线**或**点线**时，还可以配置线的间断长度值和每一个间断线之间的距离。                                                                                                                                                                                                                                                                                                                                                                                                                |
| **柱子标注** | 柱子的标注样式，单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标，控制柱子标注配置项的显隐。**标注字段**：标注的内容需要和数据面板中字段的内容对应，默认获取y字段内容。**数值格式**：设置标注的数值格式，可选**默认**、**11（整数）**、**11.1（浮点数）**、**11.11（浮点数）**、**11%（百分比）**、**11.1%（百分比）**、**1,111（千分位）**和**1,111.1（千分位）**。更多数据显示格式请参见[数据显示格式说明](https://help.aliyun.com/zh/datav/datav-6-0/product-overview/terms-1#section-os5-b6i-tok)，仅在标注字段选择range或y时显示。**前后缀**：设置柱子标注的前后缀内容。**标注位置**：选择标注内容的显示位置，可选**顶部**、**中间**和**底部**。**相对偏移**：柱子标注相对柱子在垂直和水平方向偏移量，单位为px。**文本样式**：柱子标注的文本样式，包括文本的字体样式、文字粗细、字号和颜色。**文本描边**：柱子标注的文本描边样式，包括描边线的粗细值和颜色。 |
...
| **参数**  | **说明**                                    |
| ---- | ---- |
| **最小值** | Y轴的最小值，支持自定义输入，也支持系统选择**0**和**数据最小值**。    |
...
| **更新组件配置**  | 动态更新组件的样式配置。需要先在组件的**配置**面板中，单击**复制配置到剪贴板**，获取组件配置数据。再根据需要在蓝图编辑器配置页面，数据处理节点中更改对应样式的字段值。                                                                                                                                                                                                                                                                                                                               |
