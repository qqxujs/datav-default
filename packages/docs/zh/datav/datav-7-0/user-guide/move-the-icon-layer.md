...
移动图标层是3D地球的子组件，支持独立的样式配置，包括移动图标的样式、高度和大小等。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2474841961/p703752.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2474841961/p703753.png)
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2474841961/p703754.png)

移动图标的移动位置可在`coordinates`字段中配置。
...
3. 查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4849421071/p742907.png)

  * **事件**

|    **事件**    |    **说明**    |
|    ----    |    ----    |
|    **当移动图标层请求完成时**    |    数据接口请求返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。    |
  * **动作**
...
|    **导入移动图标层**    |    按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。    |
