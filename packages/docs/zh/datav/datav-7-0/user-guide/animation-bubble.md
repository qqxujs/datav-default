...
如果图层列表中没有**呼吸气泡**，说明您还未添加**呼吸气泡**图层，请参见[添加子组件](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/layer-panel-management#section-1yb-xd4-pfe)进行添加。
...
|    **参数**    |    **说明**    |
|    ----    |    ----    |
|    **颜色**    |    设置呼吸气泡的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)修改颜色。    |
