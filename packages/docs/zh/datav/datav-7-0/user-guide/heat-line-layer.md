...
热力线层是3D地球的子组件，支持独立的样式和数据配置，包括线的长宽、渐变速度和颜色以及经纬度等，适用于绘制地理位置上的线条元素。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7328741961/p703757.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7328741961/p703758.png)
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7328741961/p703759.png)

每条线的value值可在`properties`字段中配置。
...
3. 查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7849421071/p742909.png)

  * **事件**

| **事件**         | **说明**                                                                                  |
| -------------- | --------------------------------------------------------------------------------------- |
| **当热力线层请求完成时** | 热力线层请求返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。 |
  * **动作**
...
| **导入热力线层** | 按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。                                                  |
