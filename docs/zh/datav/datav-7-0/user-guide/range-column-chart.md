...
|    **交互**    |    **说明**    |
|    ----    |    ----    |
|    **当数据项选中时**    |    打开开关，开启组件交互功能。当单击选中某个数据项时抛出临时变量，默认抛出数据中的x、y1、y2和colorField字段。具体配置请参见[组件交互配置](/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。    |
