  配置装饰组件的样式与蓝图编辑器动作-DataV数据可视化-阿里云

本文介绍装饰组件的图表样式和各配置项的含义。

## **图表样式**

装饰是媒体组件的一种，支持自定义选择装饰的类型，支持为可视化应用或可视化应用的某个模块添加自定义的装饰元素，能够使可视化应用展示更加美观。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6682271861/p633069.png)

## 配置面板

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6682271861/p633070.png)
...
-   **全局**
    ...
    **装饰元素**
    ...
    装饰元素的类型，系统提供55种装饰元素供您选择，并在下拉框中展示装饰元素的缩略图。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6682271861/p633071.png)
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**装饰**组件，在画布中可以看到如下图所示的装饰的蓝图编辑器配置参数。![装饰蓝图参数](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7088068951/p69989.jpg)
