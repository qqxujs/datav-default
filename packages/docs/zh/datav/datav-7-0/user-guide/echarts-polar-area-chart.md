...
|    **交互**    |    **说明**    |
|    ----    |    ----    |
|    **当点击饼图时**    |    打开开关，开启组件交互功能。当单击选中某个数据项时抛出回调值，默认抛出数据中的name和value字段。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。    |
|    **当选择饼图时**    |    打开开关，开启组件交互功能。当选中某个饼图时抛出回调值，默认抛出数据中的selected和name字段。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。    |
