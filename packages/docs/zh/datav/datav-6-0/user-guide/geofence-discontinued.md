...
|    高亮颜色    |    只有在开启点击事件后，可以设置地理围栏在被单击时的围栏高亮颜色，请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改颜色。    |
...
|    顶面颜色    |    只有在开启显示顶面后，可以设置围栏顶面的颜色，请参见[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改颜色。    |
