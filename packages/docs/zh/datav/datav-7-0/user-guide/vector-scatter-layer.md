...
在场景编辑器左侧图层列表中，单击**矢量散点层**图层，进入配置面板配置**矢量散点层**图层的样式和数据。 

**说明** 

如果图层列表中没有**矢量散点层**，说明您还未添加**矢量散点层**图层，请参见[添加子组件](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/layer-panel-management#section-1yb-xd4-pfe)进行添加。

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5835239861/p694074.png)
...
|    **参数**    |    **说明**    |
|    ----    |    ----    |
|    **混合模式**    |    设置矢量散点层的混合叠加渲染模式，可选**添加模式**、**正常模式**和**无叠加模式**。    |
...
## 数据面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5835239861/p694080.png)
...
1. 在当前场景编辑器页面，单击左侧图层列表中**矢量散点层**右侧的![导出到蓝图编辑器](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2434449951/p89089.jpg)图标。
2. 单击页面左上角的![蓝图图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2434449951/p89087.jpg)图标。
3. 在蓝图编辑器配置页面，单击导入节点栏内的**矢量散点层**图层，在画布中可以看到如下图所示的矢量散点层的蓝图编辑器配置参数。![蓝图配置参数](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8300648461/p422729.png)
