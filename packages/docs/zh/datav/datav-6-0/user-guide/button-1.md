...
-   **普通样式**
    ...
    -   **边框样式**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9141680861/p624474.png)
        ...
        **线条类型**
        ...
        边框的线条类型。可选：**实线**、**虚线**、**点线**、**双实线**、**雕刻效果**、**浮雕效果**、**陷入效果**和**突出效果**。
    ...
    -   **背景样式**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9141680861/p624475.png)
        ...
        **背景图片**
        ...
        单击或拖拽文件到虚线框中更换背景图片，或者在虚线框上方输入图片的`URL`链接。
        ...
        **背景图尺寸**
        ...
        背景图尺寸样式，包括**cover**、**contain**和**auto**。
    ...
    -   **文字样式**：按钮的文字样式。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9141680861/p624476.png)
        ...
        **字体样式**
        ...
        文字的字体样式，包括**normal**、**italic**、**oblique**。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**按钮**组件，在画布中可以看到如下图所示的按钮的蓝图编辑器配置参数。![节点编程参数配置](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5822652461/p51049.jpg)
    ...
    -   **动作**
        ...
        **请求数据接口**
        ...
        重新请求服务端数据，上游转换器或图层节点抛出的数据将作为参数。例如按钮配置了API数据源为`https://api.test`，传到**请求数据接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
