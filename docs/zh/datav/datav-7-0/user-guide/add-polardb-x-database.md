...
添加数据库前请先参见[创建PolarDB-X实例](/zh/polardb/polardb-for-xscale/create-polardb-x-instances)，开通对应的数据库服务。
...
|    **VPC实例ID**    |    可选VPC数据库实例 ID、 VPC 网络连接地址、VPC 网络IP地址其中一种。通过OpenAPI使用接口[DescribeDBInstanceAttribute](/zh/polardb/api-describedbinstanceattribute#doc-api-polardbx-DescribeDBInstanceAttribute)查询实例属性信息，获取实例详情中的**VPCInstanceId**。    |
