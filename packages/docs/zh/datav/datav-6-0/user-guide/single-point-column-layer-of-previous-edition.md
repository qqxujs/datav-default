  三维城市构建器单点柱状层配置说明-DataV数据可视化-阿里云
...
-   图形：图形配置面板参数说明。
    ...
    柱子的颜色配置样式，详情请参见[颜色映射器使用说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/color-mapper-instructions#concept-2067387)。
...
-   动效：动效配置面板参数说明。
    ...
    -   发光带颜色：发光带的颜色配置样式，详情请参见[颜色映射器使用说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/color-mapper-instructions#concept-2067387)。
