  标注对比饼图（v3.0及以上版本）组件配置指南-DataV数据可视化-阿里云
...
-   ****坐标轴****：饼图的径向轴和角度轴样式。
    ...
    -   ****径向轴****![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8012227761/p573137.png)
        ...
        ****网格线****
        ...
        径向轴的网格线样式，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制网格线的显隐。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的****标注对比饼图****组件，在画布中可以看到如下图所示的标注对比饼图的蓝图编辑器配置参数。![标注对比饼图蓝图参数](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8231806361/p139569.png)
    ...
    -   ****动作****
        ...
        ****请求标注对比饼图接口****
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如标注对比饼图配置了API数据源为`https://api.test`，传到****请求标注对比饼图接口****动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
