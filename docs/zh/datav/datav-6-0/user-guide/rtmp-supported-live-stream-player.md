...
RTMP视频流播放器组件暂时不支持在谷歌浏览器中播放视频，RTMP是依赖flash的，谷歌浏览器不支持flash ，您可以转换成hls格式，用阿里云流播放器组件播放视频，详情请参见[阿里云流播放器](/zh/datav/datav-6-0/user-guide/alibaba-cloud-stream-player)。
