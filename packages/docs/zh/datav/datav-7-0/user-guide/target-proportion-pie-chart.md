...
|    **内半径**    |    饼图环圈内边的半径值。    |
|    **外半径**    |    饼图环圈外边的半径值。    |
|    **进度环颜色**    |    进度环的颜色，支持颜色填充和渐变填充，请参见[颜色选择器](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
|    **目标环颜色**    |    目标环（进度环下面的底环）的颜色，请参见[颜色选择器](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
|    **越界环颜色**    |    越界环的颜色，当进度大于目标时，会显示成一圈越界环，请参见[颜色选择器](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
|    **内环颜色**    |    内环的颜色，请参见[颜色选择器](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
|    **环内斜线颜色**    |    环内斜线的颜色，请参见[颜色选择器](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
|    **环内指标颜色**    |    环内指标文本的颜色，请参见[颜色选择器](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
