...
| **当前区间变化时**    | 当前区间范围值发生变化时抛出的事件，同时抛出该值对应的数据项，参考数据示例。{   "start": 2,   "end": 6.5 }                    |
  * **动作**

| **动作**        | **说明**                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---- | ---- |
| **导入数据接口**    | 按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据，参考数据示例。\[   {     "start": 1,     "end": 4.5   } \]                                                                                                                                                                                                                                                                                                                       |
