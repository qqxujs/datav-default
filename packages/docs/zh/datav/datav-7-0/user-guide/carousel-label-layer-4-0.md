...
-   **动效**：设置轮播标签层中的轮播效果参数。
    ...
    **轮播时长**
    ...
    设置轮播标签层中的单次轮播时长样式，包括轮播时的**进入时长**，取值范围为0~5，单位秒；**停留时长**，取值范围为1~500，单位秒；**消失时长**，取值范围为0~5，单位秒；
...
-   **标签**：设置轮播标签层内标签的样式参数。
    ...
    **相对偏移**
    ...
    设置轮播标签层的标签在水平和垂直方向的相对偏移值，单位px，取值范围为-200~200。
    ...
    **背景样式**
    ...
    -   **背景阴影**：设置标签背景的阴影样式，包括阴影的颜色、阴影模糊度和阴影相对于标签在X轴和Y轴方向上的偏移值。
