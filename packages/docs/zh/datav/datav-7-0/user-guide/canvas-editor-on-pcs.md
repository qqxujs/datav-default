...
|    6    |    组件设置    |    单击画布中任意一个组件，即可在页面右侧的对话框设置该组件的**样式**、**数据源**和**高级**配置。配置方法请参见[配置项说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items)。    |