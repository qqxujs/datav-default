...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573700.png)

## 配置面板![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573701.png)
...
* ****背景色**：组件的背景颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。
* ****力引导图**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573702.png)
...
* ****文字标签配置**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573704.png)
...
* ****连接线配置**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573705.png)
...
| ****连接线最小值** | 连接线的最小值。 |
| ****连接线最大值** | 连接线的最大值。 |
* ****节点默认配置**![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573706.png)
...
| ****节点描边色**  | 节点的默认轮廓颜色。 |
| ****节点描边粗细** | 节点的默认描边粗细。 |
* ****自定义节点属性**：单击右侧的![加号图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p89097.jpg)或![垃圾桶图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3208049161/p89098.jpg)图标，添加或删除一个节点。单击![横排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p95437.jpg)或![竖排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p94077.jpg)图标配置多个自定义节点系列的排列样式。单击![复制图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5896941261/p271562.jpg)图标，即可复制当前选中节点系列配置内容并新增一个同样配置的节点系列。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573707.png)
...
## 数据面板![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6917847761/p573708.png)

### **配置字段说明**

| **字段** | **说明**                                                                                                                                                                                                                                                             |
| ---- | ---- |
| nodes  | 设置节点。包含以下字段： imgPath：如果节点需要使用图片，可设置此参数值为图片的URL地址。如果此参数的值为空，节点显示为默认的圆形。name：设置节点的标签名。type：设置节点的类型，可以在配置面板的****标签类别名**中配置。上图中的type值为group1的节点，其样式使用下图中标签类别名为group1配置。![自定义节点属性](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8602016361/p278932.png) |
| links  | 设置连接线。包含以下字段：![links字段](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5978068951/p13017.png)source：设置连接线的源节点，取值为源节点的name值。target：设置连接线的目标节点，取值为目标节点的name值。value：设置连接线的长度。                                                                           |
...
3. 在蓝图编辑器配置页面，单击导入节点栏内的****关系网络**组件，在画布中可以看到如下图所示的关系网络的蓝图编辑器配置参数。![关系网络蓝图参数](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7802093261/p69980.jpg)
