...
选中**启用**，开启组件交互功能。**瀑布图**组件拥有交互配置，当单击选中某个数据项时抛出回调值，默认抛出数据中的x和y字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。

**当图例点击时**

选中**启用**，开启组件交互功能。**瀑布图**组件拥有交互配置，当单击某个图例时抛出回调值，默认抛出数据中的selected字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。

**当数据缩放改变时**

选中**启用**，开启组件交互功能。**瀑布图**组件拥有交互配置，当数据缩放改变时抛出回调值，默认抛出数据中的start和end字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**瀑布图**组件，在画布中可以看到如下图所示的瀑布图的蓝图编辑器配置参数。![蓝图](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8668070661/p478244.jpg)
    ...
    -   事件
        ...
        **当图例点击时**
        ...
        当单击瀑布图的图例时抛出的事件，同时抛出该柱子对应的数据项。
        
        **当数据缩放改变时**
        
        当数据缩放改变时抛出的事件，同时抛出该柱子对应的数据项。
