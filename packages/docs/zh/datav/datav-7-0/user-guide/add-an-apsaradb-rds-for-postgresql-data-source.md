  将RDSforPostgreSQL添加为DataV数据源-DataV数据可视化-阿里云
    ...
    -   专有网络
        ...
        2.  填写数据库信息。
            ...
            **VPC ID**
            ...
            VPC实例的ID，此VPC为您的RDS for PostgreSQL实例所在的VPC。可进入[RDS管理控制台](https://rdsnext.console.aliyun.com/)，在**实例列表**的**网络类型**中获取。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6782767571/p1006491.png)
