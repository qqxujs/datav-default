...
-   **图形**：设置网格聚合层的图形配置项。
    ...
    **网格尺寸**
    ...
    设置网格的尺寸大小，请参见[尺寸映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/dimension-mapper-instructions)，配置不同网格的映射尺寸样式。
    
    **网格颜色**
    
    设置网格的颜色样式，请参见[颜色映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/instructions-of-color-mapper)，配置不同网格的映射颜色样式。
