...
| **当视觉映射改变时** | 打开开关，开启组件交互功能。当单击某个图例时抛出回调值，默认抛出数据中的selected字段。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。  |
...
| **当点击数据项时**    | 当单击颜色分段折线图的数据时抛出的事件，同时抛出对应的数据项。                                                         |
