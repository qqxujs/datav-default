  配置双11多维度饼图组件的样式数据与交互-DataV数据可视化-阿里云
...
-   **标签**：饼图的标签样式。
    ...
    **类目**
    ...
    标签上显示内容类目的样式，单击左侧![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制类目样式的显隐。
    ...
    **数值**
    ...
    -   **真实数值**：打开开关，显示数据中对应数据字段的值。![显示真实值样式](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5736906361/p278186.png)
...
-   **极轴**：饼图的极轴样式。
    ...
    **网络线**
    ...
    极轴的网络线样式，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制网络线的显隐。
    
    **颜色**：网络线的颜色。
    
    **颜色**
    
    各维度饼图的颜色。单击右侧的![加号图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p89097.jpg)或![垃圾桶图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3208049161/p89098.jpg)图标，添加或删除一个极轴颜色。单击![横排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p95437.jpg)或![竖排列图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0201929951/p94077.jpg)图标配置多个极轴颜色的排列样式。单击![复制图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5896941261/p271562.jpg)图标，即可复制当前选中极轴颜色配置内容并新增一个同样配置的极轴颜色。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**双11多维度饼图**组件，在画布中可以看到如下图所示的双11多维度饼图的蓝图编辑器配置参数。![蓝图编辑器页面](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6736906361/p278199.jpg)
    ...
    -   **动作**
        ...
        **请求多维度饼图接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如双11多维度饼图配置了API数据源为`https://api.test`，传到**请求多维度饼图接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
