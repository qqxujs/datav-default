...
本文介绍萤石云播放器全量选择时各配置项的含义。

## **图表样式**

萤石云播放器是媒体组件的一种，支持自定义视频的URL地址，支持RTMP和HLS协议的视频流，能够在数据看板中添加视频播放器来播放您的视频，同时视频会按照原始比例进行展示。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6279612961/p706647.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6279612961/p706650.png)
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6279612961/p706655.png)

`source`：（可选）视频流地址，与**视频流地址**配置项功能相同。若两者都进行了配置，则优先使用**数据源**面板中的配置。
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6279612961/p706657.png)
