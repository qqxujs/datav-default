...
| EndPoint  | 填写SLS服务的EndPoint。请参见[日志服务入口文档](https://help.aliyun.com/zh/sls/endpoints#reference-wgx-pwq-zdb "本文介绍了日志服务不同网络类型的服务入口。")，根据您SLS服务的网络类型和所在区域进行填写。 例如VPC网络下，上海区域的EndPoint 填写为https://cn-shanghai-intranet.log.aliyuncs.com。 |
...
**说明** 其中query参数的查询语法请参见[查询语法](https://help.aliyun.com/zh/sls/query-syntax/#concept-tnd-1jq-zdb "日志服务提供一套查询语法用于设置查询条件，帮助您更有效地查询日志。")。
