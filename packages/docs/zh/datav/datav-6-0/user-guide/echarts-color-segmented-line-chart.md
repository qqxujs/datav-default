...
* **数据缩放**：单击右侧的**眼睛**图标显示数据缩放。![数据缩放](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9088080661/p478755.jpg)
  ...
  * **背景色**：参考[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改数据背景的颜色。
  * **数据阴影**
    ...
    * **区域样式**
      ...
      * **颜色**：参考[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改区域的颜色。
      * **透明度**：单击**+**或**\-**号，或手动输入数值，修改分割区域的透明度，范围为 \[0,1\]。
    * **选中颜色**：参考[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改鼠标选中时的颜色。
    * **边框色**：参考[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改边框颜色。
    * **手柄样式**

      * **颜色**：参考[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改手柄元素的背景颜色。
      * **透明度**：单击**+**或**\-**号，或手动输入数值，修改手柄元素的透明度，范围为 \[0,1\]。
    * **实时**：单击右侧的**眼睛**图标显示或关闭实时效果。
    * **文本样式**

      * **颜色**：参考[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改文本的颜色。
      * **字体样式**：文本的字体风格。
      * **字体粗细**：文本的字体粗细。
      * **字体**：文本的字体系列。
...
* **视觉映射**：单击右侧的**眼睛**图标显示视觉映射。![视觉映射](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9088080661/p478773.jpg)
  ...
  * **未选元素**
    ...
    * **颜色**：参考[颜色选择器说明](/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)，修改未选元素的颜色。
...
|    **交互**    |    **说明**    |
|    ----    |    ----    |
|    **当点击数据项时**    |    选中**启用**，开启组件交互功能。**颜色分段折线图**组件拥有交互配置，当单击选中某个数据项时抛出回调值，默认抛出数据中的x和y字段。具体配置请参见[组件回调ID配置](/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。    |
|    **当视觉映射改变时**    |    选中**启用**，开启组件交互功能。**颜色分段折线图**组件拥有交互配置，当视觉映射改变时抛出回调值，默认抛出数据中的selected字段。具体配置请参见[组件回调ID配置](/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。    |
|    **当数据缩放改变时**    |    选中**启用**，开启组件交互功能。**颜色分段折线图**组件拥有交互配置，当数据缩放改变时抛出回调值，默认抛出数据中的start和end字段。具体配置请参见[组件回调ID配置](/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。    |
