...
-   动态轨迹层配置面板中的参数说明。
    ...
    -   **通用**
        ...
        **混合模式**
        ...
        设置动态轨迹层的柱子材质的混合叠加渲染模式，可选**添加模式**、**正常模式**和**无叠加模式**。
    ...
    -   **图形**
        ...
        **颜色**
        ...
        设置动态轨迹飞线的颜色，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)修改颜色。
