...
-   **图形**：设置图标散点层的图形配置项。
    ...
    **图标形状**
    ...
    设置图标的形状，请参见[形状映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/shape-mapper-instructions)，配置不同图标的映射形状样式。
...
打开开关，开启组件交互功能。当单击某个散点时抛出临时变量，默认抛出数据中的lng和lat字段。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。

**当鼠标移入时**

打开开关，开启组件交互功能。当鼠标移入到散点位置时抛出临时变量，默认抛出数据中的lng和lat字段。具体配置请参见[组件交互配置](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/widget-interaction-configuration)。
