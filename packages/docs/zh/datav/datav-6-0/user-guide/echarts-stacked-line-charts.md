  Echarts 堆叠折线图组件的样式数据与交互配置-DataV数据可视化-阿里云

本文介绍Echarts 堆叠折线图的图表样式和配置面板的功能。

## **图表样式**

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0052507761/p571655.png)

## 配置面板![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0052507761/p571656.png)
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0052507761/p571657.png)
...
![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0052507761/p571658.png)
...
选中**启用**，开启组件交互功能。**堆叠折线图**组件拥有交互配置，当单击选中某个数据项时抛出回调值，默认抛出数据中的x和y字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。

**当图例点击时**

选中**启用**，开启组件交互功能。**堆叠折线图**组件拥有交互配置，当单击某个图例时抛出回调值，默认抛出数据中的selected字段。具体配置请参见[组件回调ID配置](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-callback-ids-for-ticker-boards#concept-m2n-fy3-52b)。
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**堆叠折线图**组件，在画布中可以看到如下图所示的堆叠折线图的蓝图编辑器配置参数。![蓝图](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9491970661/p478662.jpg)
    ...
    -   事件
        ...
        **当点击数据项时**
        ...
        当单击堆叠折线图的柱子时抛出的事件，同时抛出该柱子对应的数据项。
        
        **当图例点击时**
        
        当单击堆叠折线图的图例时抛出的事件，同时抛出该柱子对应的数据项。
