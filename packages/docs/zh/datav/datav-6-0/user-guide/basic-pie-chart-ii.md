...
本文介绍v3.0以下版本的基本饼图的配置项，如需查看v3.x版本或者v4.0及以上版本，请参见[基本饼图（v3.x版本）](/zh/datav/datav-6-0/user-guide/basic-pie-chart-1#concept-2354931)或[基本饼图（v4.0及以上版本）](/zh/datav/datav-6-0/user-guide/the-basic-pie-chart-ii#concept-2455900)。
