...
推荐您将上一步已经[处理完成的数据](/zh/datav/datav-6-0/use-cases/process-data#concept-sbr-ss3-52b "本文档为您介绍如何将CSV格式的文件处理成JSON格式的数据。")包装成一个简单的接口，并在DataV地图组件的数据面板配置API数据源，调用此接口，来完成这个需求。 
