...
本文档为您介绍连续折线图的样式和数据的配置方法。

## **图表样式**

![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707462.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707463.png)
...
-   **x轴**：单击![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示x轴样式。
    ...
    -   **轴线**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示x轴轴线。
    ...
    -   **刻度线**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示x轴刻度。
    ...
    -   **刻度标签**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示x轴刻度标签。
    ...
    -   **分割线**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示分割线。
...
-   **提示框**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示提示框。
    ...
    -   **坐标轴指示器**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示坐标轴指示器。
...
-   **系列**：单击右侧的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528933.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528934.png)图标，添加或删除一个条件样式。 单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528936.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528937.png)图标配置多个条件样式的排列样式。单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528938.png)图标，即可复制当前选中的条件样式配置并新增一个同样配置的条件样式。
    ...
    -   **显示图标**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示图标样式。
    ...
    -   **标签**：单击右侧的![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707467.png)图标显示标签样式。
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707475.png)
...
## 高级面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707477.png)
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2309522961/p707481.png)
    ...
    -   **事件**
        ...
        **当点击数据项时**
        ...
        当单击连续折线图的数据时抛出的事件，同时抛出对应的数据项。
        
        **当图例点击时**
        
        当单击连续折线图的图例时抛出的事件，同时抛出对应的数据项。
