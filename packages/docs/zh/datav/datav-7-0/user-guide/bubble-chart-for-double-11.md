...
本文介绍双11气泡图全量选择时各配置项的含义。

## **图表样式**

双11气泡图是其他基础图表的一种，支持根据数值映射气泡的大小，能够使用气泡展示各类别的数据对比情况，适用于双11的商品对比可视化应用展示，例如展示手机、食品、衣服、家电等商品的对比。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6291690961/p701315.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6291690961/p701316.png)
...
-   **文本样式**
    ...
    **颜色**
    ...
    文本的字体颜色，请参见[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。
    ...
    **标签**
    ...
    气泡的文字标签内容，可选**值**和**名称**，单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制标签的显隐。
    
    **垂直偏移**
    
    文字标签内容在气泡中的垂直偏移值，单位px。
    
-   **节点样式**：单击右侧的![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528933.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528934.png)图标，添加或删除一个数据系列。 单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528936.png)或![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528937.png)图标配置多个数据系列的排列样式。单击![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1161599661/p528938.png)图标，即可复制当前选中数据系列配置内容并新增一个同样配置的数据系列。
    
    **颜色**：该系列下气泡的颜色。
    

## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6291690961/p701318.png)
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4033701071/p742070.png)
