...
-   **饼图属性**：饼图的基本属性样式。![饼图属性面板](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0448068951/p9439.png)
    ...
    **饼图填充底色**
    ...
    饼图的底色，显示为扇形未被覆盖的部分，请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/configure-item-description#section-kdw-vj4-t2b)进行修改。
...
-   **扇形配置**![扇形配置面板](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8896941261/p275645.png)
    ...
    **末端色值**
    ...
    扇形结束点的颜色，饼图中的扇形颜色为起点颜色到末端颜色的渐变色。
...
-   **中间百分比部分**：饼图中间百分比部分的样式。
    ...
    **外框占比**
    ...
    中间百分比部分的宽度，输入数值为所占饼图外半径的比例，取值范围为0~1。若设置的小，会导致数字和符号显示在两行，过小则会挤在一起。![外框占比](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8896941261/p275647.png)
    ...
    **百分比偏移值**
    ...
    百分号和百分数的距离。 ![中间百分比部分面板](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1448068951/p9442.png)
...
3.  在蓝图编辑器配置页面，单击导入节点栏内的**单值百分比饼图**组件，在画布中可以看到如下图所示的单值百分比饼图的蓝图编辑器配置参数。![节点编程面板](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7533401161/p49133.png)
    ...
    -   **动作**
        ...
        **请求单值百分比饼图接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如单值百分比饼图配置了API数据源为`https://api.test`，传到**请求单值百分比饼图接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
