...
|    **填充颜色**    |    线条的填充颜色，请参见[颜色选择器说明](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
* **箭头样式**：箭头标绘中箭头的样式。  
...
|    **填充颜色**    |    箭头的填充颜色，请参见[颜色选择器说明](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
* **文本样式**：箭头标绘中文本的样式。  
...
|    **字号**    |    文本的字号大小。    |
|    **字体颜色**    |    文本的字体颜色，请参见[颜色选择器说明](/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
|    **字体粗细**    |    字体的粗细。    |
|    **字体**    |    字体的样式，默认微软雅黑。    |
