  DataV添加RDS for PostgreSQL数据源-DataV数据可视化-阿里云
...
5.  选择内网数据库的网络类型（包括**专有网络**和**经典网络**）。
    -   **专有网络**
        1.  打开**VPC**开关，进入**专有网络**模式。![添加RDS for PostgreSQL数据源（内网）专有网络](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6981415261/p55610.png)
        2.  填写数据库信息。
            ...
            **VPC ID**
            ...
            VPC实例的ID，此VPC为您的RDS for PostgreSQL实例所在的VPC。可进入[RDS管理控制台](https://rdsnext.console.aliyun.com/)，在**实例列表** > **基本信息** > **网络类型**中获取。![获取VPC ID](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8244964951/p55693.png)
    ...
    -   **经典网络**
        ...
        2.  填写数据库信息。![添加RDS for PostgreSQL数据源（内网）经典网络](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6981415261/p7869.png)
