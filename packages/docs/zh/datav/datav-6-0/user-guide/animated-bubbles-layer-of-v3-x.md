  呼吸气泡层（v3.x版本）配置项说明-DataV数据可视化-阿里云
...
-   **图形**：设置呼吸气泡层的图形配置项，包括气泡的形状样式、半径大小样式和气泡颜色样式。
    ...
    **气泡形状**
    ...
    设置气泡的形状样式，请参见[形状映射器使用说明](https://help.aliyun.com/zh/datav/datav-6-0/user-guide/instructions-of-shape-mapper#concept-2067398)，配置不同气泡的映射形状样式。
