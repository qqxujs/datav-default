...
重新选择数据：在数据面板内可以单击下方重新选择数据，打开选择范围对话框，重新选择仅针对地形图层的数据范围，详情请参见[使用官方基底数据方式创建](https://help.aliyun.com/document%5Fdetail/193468.html#section-bsj-xjl-qx7)中的选择场景范围区域的操作步骤。
