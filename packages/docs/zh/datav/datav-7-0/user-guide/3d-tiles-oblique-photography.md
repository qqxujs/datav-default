...
3D Tiles 倾斜摄影是三维城市构建器的图层，支持独立的样式和数据配置，包括3D Tiles 倾斜摄影的通用配置和交互配置样式。本文介绍3D Tiles 倾斜摄影配置项的含义。

在场景编辑器左侧图层列表中，单击3D Tiles 倾斜摄影图层，进入配置面板配置3D Tiles 倾斜摄影图层的样式和数据。

**说明**

-   当前组件目前仅供**DataV尊享版**用户使用。如需使用该组件，请先将版本升级至尊享版。
    
-   如果图层列表中没有3D Tiles 倾斜摄影，说明您还未添加3D Tiles 倾斜摄影图层，请参见[添加子组件](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/layer-panel-management#section-1yb-xd4-pfe)进行添加。
    

## 样式面板

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1888001761/p535381.png)
...
-   **通用** ：3D Tiles 倾斜摄影配置面板中的参数说明。
    ...
    **最大屏幕空间误差**
    ...
    设置3D Tiles 倾斜摄影的最大屏幕空间误差，取值范围为8~100。
    

## 数据面板

![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1888001761/p535387.png)
...
3D Tiles 倾斜摄影的三维服务URL，如//%/realspace/datas/%/config。
...
1.  在当前场景编辑器页面，单击左侧图层列表中3D Tiles 倾斜摄影右侧的![导出到蓝图编辑器](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2434449951/p89089.jpg)图标。
    
2.  单击页面左上角的![蓝图图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2434449951/p89087.jpg)图标。
    
3.  在蓝图编辑器配置页面，单击导入节点栏内的3D Tiles 倾斜摄影图层，在画布中可以看到如下图所示的3D Tiles 倾斜摄影的蓝图编辑器配置参数。![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1888001761/p535390.png)
    ...
    -   **动作**
        ...
        **请求数据接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如3D Tiles 倾斜摄影配置了API数据源为`https://api.test`，传到**请求数据接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
