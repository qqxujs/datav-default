...
-   **图形**：设置呼吸气泡层的图形配置项，包括气泡的形状样式、半径大小样式和气泡颜色样式。
    ...
    **气泡形状**
    ...
    设置气泡的形状样式，请参见[形状映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/shape-mapper-instructions)，配置不同气泡的映射形状样式。
...
-   **标签**：设置呼吸气泡层内标签的样式参数。
    ...
    **显示方式**
    ...
    设置呼吸气泡层的标签显示的方式，可选，包括**点击**和**悬浮**两种方式。
    
    **相对位置**
    
    设置呼吸气泡层的标签的相对位置样式，可选，包括**左侧**、**中心**、**右侧**、**顶部**和**底部**。
...
-   **自定义弹框样式**：设置呼吸气泡层内自定义弹框的样式参数。
    ...
    **显示方式**
    ...
    设置呼吸气泡层弹框显示的方式，可选，包括**点击**和**悬浮**两种方式。
