...
本文档为您介绍基本折线图的样式和数据的配置方法。

## **图表样式**![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1063062961/p708596.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1063062961/p708598.png)
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1063062961/p708601.png)
...
## 高级面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1063062961/p708605.png)
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1063062961/p708606.png)
    ...
    -   **事件**
        ...
        **当点击数据项时**
        ...
        当单击基本折线图的数据时抛出的事件，同时抛出对应的数据项。
        
        **当图例点击时**
        
        当单击基本折线图的图例时抛出的事件，同时抛出对应的数据项。
    ...
    -   **动作**
        ...
        **请求数据接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如基本折线图配置了API数据源为`https://api.test`，传到**请求数据接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
