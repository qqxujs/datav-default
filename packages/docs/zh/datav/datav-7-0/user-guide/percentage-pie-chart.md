...
本文介绍指标对比饼图全量选择时各配置项的含义。

## **图表样式**

指标对比饼图是饼图的一种，与基本饼图相比，指标对比饼图能够同时展示数据的真实值和百分比值，适用于展示两个指标数据的对比情况，仅支持两个数据系列的配置。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5561790961/p701189.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5561790961/p701190.png)
...
* **标签**：饼图的标签样式，可单击![眼睛图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8648413261/p89095.jpg)图标控制标签的显隐。  

|    **参数**    |    **说明**    |
|    ----    |    ----    |
|    **颜色**    |    上方和下方标签的颜色，请参见[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。    |
...
**颜色**：此系列下饼图中扇形的颜色。
* **动画**：饼图的动画效果样式，可单击![开关图标](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/1986941261/p274464.jpg)图标控制动画效果的开启或关闭。

  * **初始动画时长**：组件第一次渲染动画的时长，单位为ms。
  * **缓动效果**：动画的缓动效果，系统提供多种常见的动画缓动效果供您选择。
  * **更新动画时长**：组件数据更新时的动画时长，单位为ms。

## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5561790961/p701191.png)
...
3. 查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0486601071/p742012.png)

  * **事件**

|    **事件**    |    **说明**    |
|    ----    |    ----    |
|    **当指标对比饼图接口请求完成时**    |    数据接口请求返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。    |
  * **动作**

|    **动作**    |    **说明**    |
|    ----    |    ----    |
|    **导入指标对比饼图接口**    |    按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。    |
