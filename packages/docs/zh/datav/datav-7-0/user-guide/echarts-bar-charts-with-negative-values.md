...
Echarts 正负条形图是条形图的一种，支持自定义x轴、多系列数据配置以及正负分维度式的数据展示，可以在较小的可视化应用空间内，智能地展示多维的数据差异。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0095772961/p709693.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0095772961/p709694.png)
...
-   **x轴**：单击右侧的**眼睛**图标显示x轴样式。
    ...
    -   **轴线**：单击右侧的**眼睛**图标显示x轴轴线。
        ...
        -   **线样式**
            ...
            -   **颜色**：单击下拉框，选择轴线颜色的填充样式，包括**颜色填充**和**渐变填充**。参考[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)，修改x轴轴线的颜色。
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0095772961/p709697.png)
...
## 高级面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0095772961/p709699.png)
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/0095772961/p709703.png)
    ...
    -   **事件**
        ...
        **当点击数据项时**
        ...
        当单击正负条形图的数据时抛出的事件，同时抛出对应的数据项。
        
        **当图例点击时**
        
        当单击正负条形图的图例时抛出的事件，同时抛出对应的数据项。
    ...
    -   **动作**
        ...
        **请求数据接口**
        ...
        重新请求服务端数据，上游数据处理节点或图层节点抛出的数据将作为参数。例如正负条形图配置了API数据源为`https://api.test`，传到**请求数据接口**动作的数据为`{ id: '1'}`，则最终请求接口为`https://api.test?id=1`。
