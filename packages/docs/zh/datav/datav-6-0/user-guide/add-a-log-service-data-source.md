  在DataV中添加并使用日志服务SLS数据源-DataV数据可视化-阿里云
...
4.  填写简单日志服务SLS相关信息。
    ...
    填写SLS服务的EndPoint。请参见[日志服务入口文档](https://help.aliyun.com/zh/sls/endpoints#reference-wgx-pwq-zdb "本文介绍了日志服务不同网络类型的服务入口。")，根据您SLS服务的网络类型和所在区域进行填写。
