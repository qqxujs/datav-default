...
蜂窝聚合层是基础平面地图 3.0的子组件，支持独立的样式和数据配置，包括蜂窝的半径大小、颜色、间距和标注等，能够以聚合蜂窝点的形式表现地理位置上的点的分布密度。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3568831961/p702899.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3568831961/p702900.png)
...
-   **图形**：设置蜂窝聚合层的图形配置项。
    ...
    **蜂窝半径**
    ...
    设置蜂窝的半径大小，请参见[尺寸映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/dimension-mapper-instructions)，配置不同蜂窝的映射半径尺寸样式。
    
    **蜂窝颜色**
    
    设置蜂窝的颜色样式，请参见[颜色映射器使用说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/instructions-of-color-mapper)，配置不同蜂窝的映射颜色样式。
    ...
    **文本样式**：设置标注文字的字体、文字粗细、字号和颜色。请参见[颜色选择器说明](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改颜色。
    

## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/3568831961/p702901.png)
...
3.  查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7632221071/p742528.png)
