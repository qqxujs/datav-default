...
本文介绍单值百分比饼图全量选择时各配置项的含义。

## **图表样式**

单值百分比饼图是饼图的一种，与基本饼图相比，单值百分比饼图适用于展示单个类别与总体的数据占比情况，不支持多数据系列的配置。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4299590961/p701169.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4299590961/p701170.png)
...
| **饼图填充底色** | 饼图的底色，显示为扇形未被覆盖的部分，请参见[颜色选择器](https://help.aliyun.com/zh/datav/datav-7-0/user-guide/configuration-items#section-kdw-vj4-t2b)进行修改。 |
* **扇形配置**
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4299590961/p701171.png)
...
3. 查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/8386601071/p742011.png)

  * **事件**

| **事件**              | **说明**                                                                                  |
| ---- | ---- |
| **当单值百分比饼图接口请求完成时** | 数据接口请求返回并经过过滤器处理后抛出的事件，同时抛出处理后的JSON格式的数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。 |
  * **动作**

| **动作**          | **说明**                                                                                                                                                                                                                                                                                                                                                                                                       |
| ---- | ---- |
| **导入单值百分比饼图接口** | 按组件绘制格式处理数据后，导入组件，重新绘制。不需要重新请求服务端数据。具体数据示例请参见画布编辑器中组件右侧配置面板**数据源**页签的**数据响应结果**区域。                                                                                                                                                                                                                                                                                                                           |
