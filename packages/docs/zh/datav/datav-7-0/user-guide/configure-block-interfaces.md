...
5. 单击**逻辑节点**面板中的**区块接口**，即可配置交互接口节点的蓝图配置，详情接口蓝图配置请参见[使用区块接口](/zh/datav/datav-7-0/user-guide/use-block-interfaces)。  
...
8. 参见[预览、发布和使用项目](/zh/datav/datav-7-0/user-guide/preview-publish-and-use-a-project)，将配置完成的三维城市构建器项目添加到画布编辑器中，您可以在画布编辑器右侧配置面板的数据面板和交互面板中，查看在项目中自定义配置的数据接口内容及事件设置内容。  
