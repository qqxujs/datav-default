...
本文介绍视频组件全量选择时各配置项的含义。

## **图表样式**

视频是媒体组件的一种，支持自定义视频的URL地址、视频播放属性、播放器的外观属性等，支持mp4格式的视频，能够在可视化应用中添加视频播放器来播放您的视频。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6179612961/p706564.png)

## 样式面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6179612961/p706565.png)
...
* **视频地址**：建议使用mp4格式的视频地址（如：xx.test.com/video.mp4），也可以在**数据源**面板中配置，优先使用**数据源**面板中的配置。
* **空视频文案**：在没有具体视频时，用来提醒用户的文本，一般显示在组件内部上方。
* **自动播放**：打开开关，在预览或发布页面视频可自动播放。  

**重要**  
  * 当使用Chrome 66以下版本时，需要按照以下方法开启自动播放功能，配置项才有效。  
...
## 数据源面板![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6179612961/p706566.png)

`url`：（可选）配置视频资源的地址，与**视频地址**配置项功能相同。若两者都进行了配置，则优先使用数据源中的配置。
...
3. 查看蓝图配置参数。![image.png](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/6179612961/p706568.png)
