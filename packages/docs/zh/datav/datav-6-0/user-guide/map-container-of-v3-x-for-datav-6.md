...
| **参数**     | **说明**                                                                                                                                                           |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ****通用坐标** | 通用坐标包括****EPSG3857**、****EPSG3395**、****EPSG4326**和****BD09**，系统默认设置为****EPSG3857**坐标系，如果切换成别的类型的通用坐标，底图层对应的瓦片URL需要重新设置。                                         |
...
| ****地图移动时**      | 地图中心点发生移动时抛出的事件，参考数据示例如下。return {   "type": "flyTo",//类型   "zoom": "1",//缩放级别   "lng": "102.4",//经度   "lat": "34.0"//维度 } |
| ****地图移动结束**     | 地图中心点移动结束时抛出的事件，参考数据示例如下。return {   "type": "flyTo",//类型   "zoom": "1",//缩放级别   "lng": "102.4",//经度   "lat": "34.0"//维度 } |
  * ****动作**
...
| ****显示**       | 显示组件，不需要参数。                                                                                                                                                                                                                                                                                                                                      |
| ****隐藏**       | 隐藏组件，不需要参数。                                                                                                                                                                                                                                                                                                                                      |
| ****设置视图**     | 设置地图视图的地图中心点和缩放级别，参考数据示例如下。return {   "zoom": 6,   "lng": 108,   "lat": 38 }                                                                                                                                                                                                                                                                     |
| ****设置缩放级别**   | 设置地图的缩放级别，参考数据示例如下。//设置缩放级别 return {"zoom": 6}                                                                                                                                                                                                                                                                                                   |
| ****设置缩放范围**   | 设置地图的级别缩放范围，参考数据示例如下。//设置缩放级别范围：\[最小级别，最大级别\]。 return {   "range": \[3,20\] }                                                                                                                                                                                                                                                                    |
| ****设置最大视图范围** | 设置地图最大视图的坐标范围，参考数据示例如下。//坐标范围：\[\[最小纬度,最小经度\],\[最大纬度,最大经度\]\] return {   "zoom": 1,   "bounds":    \[     \[-90,-180\],     \[90,180\]   \] }                                                                                                                                                                                                    |
| ****飞行到指定位置**  | 设置飞行到指定位置点的经纬度和缩放级别和飞线的时间间隔，参考数据示例如下。return {   "zoom": 4.5,//缩放级别，需要在设置的缩放级别范围内。   "lng": 108,//经度范围：\[-180,180\]   "lat": 38,//纬度范围：\[-90,90\]   "duration": 0.25//间隔时间，单位：秒 }                                                                                                                                                                 |
| ****飞行到指定范围**  | 设置飞行到指定范围的坐标范围和飞行间隔时间，参考数据示例如下。return {   "bounds": //坐标范围：\[\[最小纬度,最小经度\],\[最大纬度,最大经度\]\]  \[      \[0,72\],     \[53,138\]   \],   "duration": 0.25//时间间隔，单位：秒 }                                                                                                                                                                               |
